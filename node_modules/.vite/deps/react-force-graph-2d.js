...
function $() {
  for (var n2, u2, t5, r2, o2, f2, c5, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t5 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t5 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t5), O(u2.__P, t5, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c5), t5.__v = r2.__v, t5.__.__k[t5.__i] = t5, z(f2, t5, c5), t5.__e != o2 && C2(t5)));
  $.__r = 0;
}
function I(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, w2, d2, g2, _2 = t5 && t5.__k || v, m3 = l2.length;
  for (f2 = P(u2, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : _2[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, r2, o2, e3, f2, c5, s2), w2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && q(h2.ref, null, y3), s2.push(y3.ref, y3.__c || w2, y3)), null == d2 && null != w2 && (d2 = w2), 4 & y3.__u || h2.__k === y3.__k ? f2 = A2(y3, f2, n2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), y3.__u &= -7);
  return u2.__e = d2, f2;
}
function P(n2, l2, u2, t5, i2) {
  ...
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = S(e3)), B2(e3, e3));
  return t5;
}
...
function L(n2, l2, u2, t5) {
  ...
  if (null === f2 && null == n2.key || f2 && o2 == f2.key && e3 == f2.type && 0 == (2 & f2.__u)) return u2;
  if (t5 > (null != f2 && 0 == (2 & f2.__u) ? 1 : 0)) for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) {
    if (i2 >= 0) {
...
function O(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n: if ("function" == typeof j2) try {
    if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t5.__c ? m3 = (h2 = u2.__c = t5.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D2), C3 && C3.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) S2 && null == j2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = d(d({}, i2), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f2 = I(n2, w(L2) ? L2 : [L2], u2, t5, i2, r2, o2, e3, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), m3 && (h2.__E = h2.__ = null);
  } catch (n3) {
    ...
    else u2.__e = t5.__e, u2.__k = t5.__k;
    l.__e(n3, u2, t5);
  }
  else null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = V(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
  return (a3 = l.diffed) && a3(u2), 128 & u2.__u ? void 0 : f2;
}
function z(n2, u2, t5) {
  for (var i2 = 0; i2 < t5.length; i2++) q(t5[i2], t5[++i2], t5[++i2]);
...
function V(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
...
function B2(n2, u2, t5) {
  ...
  if (i2 = n2.__k) for (r2 = 0; r2 < i2.length; r2++) i2[r2] && B2(i2[r2], u2, t5 || "function" != typeof n2.type);
  t5 || g(n2.__e), n2.__c = n2.__ = n2.__e = void 0;
}
function D2(n2, l2, u2) {
  return this.constructor(n2, u2);
}
function E2(u2, t5, i2) {
  var r2, o2, e3, f2;
  t5 == document && (t5 = document.documentElement), l.__ && l.__(u2, t5), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t5.__k, e3 = [], f2 = [], O(t5, u2 = (!r2 && i2 || t5).__k = _(k, null, [u2]), o2 || p, p, t5.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t5.firstChild ? n.call(t5.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t5.firstChild, r2, f2), z(e3, u2, f2);
}
function J(l2, u2, t5) {
...
var render = function render2(jsx, domEl) {
  delete domEl.__k;
  E2(_reactElement2VNode(jsx), domEl);
};
